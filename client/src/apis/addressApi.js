...
const addressApi = {
  ...
  // api: lấy danh sách huyện/quận theo id tỉnh
  getWardList: (provinceId, districtId) => {
  ...
  putSetDefaultDeliveryAddress: (userId, index) => {
    const url = ADDRESS_API_ENDPOINT + "/delivery/edit";
    return axiosClient.put(url,  { userId, index } );
  },
};
